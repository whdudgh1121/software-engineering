document.addEventListener("DOMContentLoaded", function() {
    const achievements = [
        ...
        { id: "achievement-3", condition: (stats) => stats.benchPress >= 0 && stats.benchPress < 120 },
        { id: "achievement-4", condition: (stats) => stats.benchPress >= 120 },
        { id: "achievement-5", condition: (stats) => stats.deadlift >= 0 && stats.deadlift < 80 },
        { id: "achievement-6", condition: (stats) => stats.deadlift >= 0 && stats.deadlift < 130 },
        { id: "achievement-7", condition: (stats) => stats.deadlift >= 130 },
        { id: "achievement-8", condition: (stats) => stats.squat >= 0 && stats.squat < 80 },
        { id: "achievement-9", condition: (stats) => stats.squat >= 0 && stats.squat < 150 },
        { id: "achievement-10", condition: (stats) => stats.squat >= 150 },
        { id: "achievement-11", condition: (stats) => stats.total < 200 },
        { id: "achievement-12", condition: (stats) => stats.total < 300 },
        { id: "achievement-13", condition: (stats) => stats.total < 400 },
        { id: "achievement-14", condition: (stats) => stats.total < 500 },
